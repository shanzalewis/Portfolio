 ...
 * This is the Bottles class for Vending Machine Simulator which stores the candy.
 * The user is prompted to select their drink and their total is displayed. 
...
public class Bottles 
{
	...
	Bottles()      //empty constructor
	{
		this.item_num = 0;
		this.bottles = "Row1 - Bottles.txt";
	...
	/**
     * Prompts user to select drink and sets variables.
     * @param	String[]line
     * @param	String[]s
     * @param	String info
     * @param	String name
     ...
     */
    Bottles(String[]line, String[]s, String info, String name, String cost,
    		String amount, double item_cost, int item_amount, String amt_rem, String bottles, int item_num,
    		int amount_remaining) throws Exception
	{
    	...
    	System.out.println();
		System.out.print("1 - Coke ($2), 2 - Pepsi ($2), 3 - Sprite ($2), 4 - Fanta ($2)" + "\nSelect Item: ");
		item_num = (input.nextInt()*2) + 1;
		setItem(line, s, info, name, cost,
			        		amount, item_cost, item_amount, amt_rem,bottles, item_num,
			        		amount_remaining);
	}
    
    /**
     * Reads Bottles text file. Reads quantity of user's selection and price. 
    		...
    		int amount_remaining) throws Exception
	{
    	try
		{
			File f = new File("Row1 - Bottles.txt");        //new File to store bags text file
			File fn = new File("Bottles2.txt");            //new file to print out bags text file
