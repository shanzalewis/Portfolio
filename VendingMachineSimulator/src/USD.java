 ...
 * This is the USD class for Vending Machine Simulator which stores the denominations
 * and their quantities for the USD currency. The user is prompted to insert payment until
...
public class USD 
{
     ...
     * @param	double total
     */
	USD(int money, double total_bottle, double total_bag, double total_paper_wrapper, double owed, String[] line, String info, String[] s, Bottles bottle_item, String name, String cost,
			...
			String info, String[] line, int new_quantity ) throws Exception
	{
		...
		try
		{
			File f = new File("USD.txt");
			File fn = new File("USD2.txt");
  		  ...
  		  Bags bag_item, PaperWrapper paper_wrapper_item, String bags, String paper_wrapper) throws Exception
	{
		...
		if (change > 0)
		{
			...
			{
				money = 7;
				countUSD(money, total, denom, s, quantity, currency_quantity, quantity_remaining, quant_rem, info, line, new_quantity, owed, bottle_item, name, cost,
     ...
     * @param	double total
     */
	public static void countUSD(int money, double total, String denom, String[] s, String quantity, int currency_quantity, 
